        ...
        for par in pares:
            if (self.realizar(pCrossover)):            
                for i in range(2):
                    ...
                    numABuscar = int(par[i][0]) #El numero que tenemos que buscar en padre1
                    ...
                    while numABuscar not in hijo:
                        ...
                        numABuscar = int(par[abs(i-1)][index]) #Obtenemos el numero que esta abajo del que acabamos de agregar al hijo
                        index = par[i].index(numABuscar) #Obtenemos el index del numero que acabamos de obtener
