...
def getMinRecorrido(df=df):
    ...
    for col in df.columns:
        ...
        getRecorrido(col,i,recorrido,distancias)

        #print("DISTANCIA "+col+": "+str(recorrido[-1]))    Linea para mostrar todos

        if len(minReco) == 0 or recorrido[-1] < minReco[-1]:
            minReco = recorrido
...
minReco = getMinRecorrido()               
print("Recorrido: ", minReco)